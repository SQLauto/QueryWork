...
/*
	...
	$Archive: /SQL/QueryWork/Index_GetDupesAndOverLap.sql $
	$Revision: 1 $	$Date: 14-06-16 11:55 $
...
WHERE
	EXISTS ( SELECT
			 ...
			 WHERE
				...
				AND (DUPE1.key_column_list LIKE LEFT(DUPE2.key_column_list, LEN(DUPE1.key_column_list))
