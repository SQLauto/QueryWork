...
/*
	...
	$Revision: 1 $	$Date: 17-04-27 11:20 $
*/
Select	 [JobName] = [jobs].[name]
		...
		,[Frequency] = 
				CASE [schedule].[freq_subday_type]
					...
					ELSE ''
				End
        , [jobhistory].[AvgDuration]
		-- Generates Arithmetic Overflow
--		,[AvgDurationInSec] = Cast(Coalesce([jobhistory].[AvgDuration], 0.0) As Decimal(18,2))
		,[Next_Run_Date] = 
