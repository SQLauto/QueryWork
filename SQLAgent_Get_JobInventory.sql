...
https://www.mssqltips.com/sqlservertip/4870/sql-server-agent-jobs-monitoring-script/
	...
	$Archive: /SQL/QueryWork/SQLAgent_Get_JobInventory.sql $
	$Revision: 1 $	$Date: 17-10-18 14:26 $
...
SELECT @Min_hist_length = 100,                     -- minimum history per job
       @DBA_Group       = 'WAYNE\sg-Dal-SQLAdmin',     -- DBA group name in Active Directory
       @DBA_Op_Email    = 'Dal.Simmons_DBAs@DoveFS.com', -- DBA group distribution email (for an operator)
       @DBA_Operator    = 'ClearView DBA'          -- DBA Operator name
